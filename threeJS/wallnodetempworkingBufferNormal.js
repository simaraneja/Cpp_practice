...
/*
        ...
        var leftIndicesPatternLower = [0,1,2,0,2,3];
             incrementor = Math.max(...finalIndices);
               for(var i = 0; i<leftIndicesPatternLower.length;i++){
                   ...
                   console.log(leftIndicesPatternLower);
               }
        for(var i=0; i<1; i++) {
    ...
    var totalPoints = {
        center : [new THREE.Vector3(-90, 0, 0),new THREE.Vector3(0, 0, 0),new THREE.Vector3(50, 0, 0),new THREE.Vector3(100, 0, 0),new THREE.Vector3(130, 0, 0),new THREE.Vector3(170, 0, 0)],
