...
FoyrFP.WallEdge = function(options, geometry, material) {
    ...
    this.mesh3D = new THREE.Mesh(new THREE.BufferGeometry(), new THREE.MeshBasicMaterial({side: THREE.DoubleSide, wireframe: false /*color: 0xffff00*/}));
