...
var UVs = [];
// UVs[0] = new Array(new THREE.Vector2(0, 1), new THREE.Vector2(0, 0), new THREE.Vector2(1 / 6, 1));

// geom.faceVertexUvs[0] = UVs[0];
...
uvFaces.push(new THREE.Vector2(4 / 6, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(5 / 6, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(5 / 6, 1));
...
geom.faceVertexUvs[0].push(new THREE.Vector2(3 / 6, 1));
geom.faceVertexUvs[0].push(new THREE.Vector2(3 / 6, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(4 / 6, 1));

geom.faces.push(new THREE.Face3(7, 2, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(3 / 6, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(4 / 6, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(4 / 6, 1));

geom.faces.push(new THREE.Face3(1, 3, 4));
geom.faceVertexUvs[0].push(new THREE.Vector2(1 / 6, 1));
geom.faceVertexUvs[0].push(new THREE.Vector2(1 / 6, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(2 / 6, 1));

geom.faces.push(new THREE.Face3(3, 6, 4));
geom.faceVertexUvs[0].push(new THREE.Vector2(2 / 6, 1));
geom.faceVertexUvs[0].push(new THREE.Vector2(2 / 6, 0));
geom.faceVertexUvs[0].push(new THREE.Vector2(2 / 6, 1));
